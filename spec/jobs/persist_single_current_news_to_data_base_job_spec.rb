...
# Checking passed arguments to job
  it "passed new_news as hash argument successfully" do
    ActiveJob::Base.queue_adapter = :test
    new_news = {
          id_news: "a5467dd9-95d3-4fd1-bf65-551424643527", title: "American...",
          description: "Currently...", url: "https://kwwl...",
          author: "Meg Swanson", image: "https://qui...",
          language: "en", published: "2021-09-01 23:19:09.000000000 +0000",
          category_id: 617
        }
